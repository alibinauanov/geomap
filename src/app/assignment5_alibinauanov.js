...
function AirlineRoutes() {
    ...
    return (
        <Container>
            <Row className={"justify-content-md-left"}> {/* style={{ backgroundColor: "#2a5599" }} */}
                <Col lg={10}>
            ...
            <Row className={"justify-content-md-left"}>
                <Col lg={4}>
                    <h2>Airlines</h2>
                    <svg id={"barchart"} className={styles.svgStyle} width={barchart_width} height={barchart_height}>
                        <BarChart
                ...
                <Col lg={4}>
                    <h2>Airports</h2>
                    <svg id={"map"} className={styles.svgStyle} width={map_width} height={map_height}>
                        <AirportMap
                            width={map_width}
                            height={map_height}
                            countries={map}

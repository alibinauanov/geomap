...
import { groupByAirline, groupByAirport } from "../app/components/assignment6/utils";
import styles from "../app/assignment6_styles.module.css";
import { AirportMap }  from "../app/components/assignment6/airportMap";
import { BarChart } from "../app/components/assignment6/barChart";
import { AirportBubble} from "../app/components/assignment6/airportBubble";
...
function AirlineRoutes() {
    ...
    return (
        <Container>
            ...
            <Row className="align-items-start g-0" style={{ margin: 0 }}>
                {/* Bar Chart */}
                <Col lg={3} style={{ padding: 14, margin: -14 }}>
                    <h2>Airlines</h2>
                    <svg
                ...
                {/* Airport Map */}
                <Col lg={6} style={{ padding: 24, margin: -24 }}>
                    <h2>Airports</h2>
                    <svg
                        className={styles.svgStyle}
                        id={"map"}
